 ...
 * instante?".
 *
 * <p><b>Dois consumidores, um método:</b>
 * <ol>
 ...
 *       isso o gateway (BFF) renovaria o access token silenciosamente, reemitindo credenciais
 *       válidas indefinidamente e derrotando a checagem dos resource servers.</li>
 *   <li><b>Caminho degradado da re-derivação na emissão</b>
 *       ({@code AuthorizationEndpointRevalidationFilter}, ADR-025): com o user-service fora, é a
 *       única checagem que precisa apenas do Redis. O instante comparado é o <b>instante de
 *       autenticação da sessão</b> — que a re-derivação nunca re-carimba, sob pena de
 *       {@code epoch > instante} nunca mais ser verdadeiro e o caminho degradado virar
 *       decorativo.</li>
 * </ol>
 *
