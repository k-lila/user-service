...
- **Controllers:**
  - `UserController` — público, via gateway. Só opera sobre o próprio titular autenticado (`/me`, update, `/remove/me`, `/delete/me`, registro, verify/resend); a leitura por id/e-mail de terceiro saiu daqui (ADR-016, fix G1) e virou ADMIN-only no `AdminController`.
